...
class ExecuteDay2 extends FunSuite{
    val testCase =
    ...
    test("spredsheet day two frist part") {
        println("First solution for day two is: " + new Spreadsheet(testCase).checksum)
    }
    ...
    test("calc quotient sum") {
        println("Second solution for day two is: " + new Spreadsheet(testCase).sumOfEvenDivides)
    }
}
