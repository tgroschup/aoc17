...
class ExecuteDay4 extends FunSuite {
    ...
    private val string1: String = s"aa bb cc dd ee\n"
    private val string2: String = s"aa bb cc dd aa\n"
    private val string3: String = s"aa bb cc dd aaa\n"
    ...
    test("Solution one") {
        println("First solution of day four: " + new Passphrase(input).countValid)
    }
}
